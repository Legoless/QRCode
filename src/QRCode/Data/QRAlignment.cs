...
namespace QRCode.Data
{
    ...
    {
        private static byte[,] _alignmentPos = new byte[,]
                                                   {
                                                       {6, 0, 0, 0, 0, 0, 0},
                                                       {6, 18, 0, 0, 0, 0, 0},
                                                       {6, 22, 0, 0, 0, 0, 0},
        ...
        public static byte[] GetAlignment (int version)
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                positions.Add (_alignmentPos[version - 1, i]);
            }
        ...
        public static void CalculateAlignments ()
        {
            ...
            for (int i = 6; i < 40; i++)
            {
                ...
                _alignmentPos[i, 0] = 6;
                _alignmentPos[i, alignCount] = (byte) (startSize - 7);
                ...
                {
                    _alignmentPos[i, x] = (byte) (6 + (divider * x));

                    if (_alignmentPos[i, x] % 2 == 1)
                    {
                        _alignmentPos[i, x]--;
                    }
                }
